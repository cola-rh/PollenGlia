setwd("/omics/groups/OE0246/internal/guz/cola_hc/examples/PollenGlia")
library(cola)
...
library(scRNAseq)
data = readRDS('/omics/groups/OE0246/internal/guz/cola_hc/examples/PollenGlia/PollenGlia_data.rds')
